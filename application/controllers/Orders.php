			  ...
			  <section class="invoice">
			    ...
			    <div class="row invoice-info">
			      ...
			      <div class="col-sm-4 invoice-col">
			        <b>Kode</b> '.':' . ' ' . $order_data['bill_no'].'<br>
			        <b>Store</b> '.':' . ' ' . $store_data['name'].'<br>
					<b>Meja</b> '.':' . ' ' . $table_data['table_name'].'<br>
			        <b>Total</b> '.':' . ' ' . count($orders_items). ' ' . 'Menu'.'<br><br>
			      </div>
			      <!-- /.col -->
			    </div>
			    <!-- /.row -->
			    ...
			    <div class="row">
			      ...
			      <div class="col-xs-6 pull pull-right">
			        ...
			        <div class="table-responsive">
			          <table class="table">
			            <tr>
			              <th style="width:20%">Total Awal</th>
