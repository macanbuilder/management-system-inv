...
(1, 'CODING COFFEE', '20', '10', 'Jl- Sumatra, Joglo Raya, Pekalongan, Jawa Tengah, Indonesia', '085865655044', 'Indonesia', '<p>Minum kopi sambil ngoding...</p>', 'IDR');
...
(13, 'BILPR-F5FD', '1582223396', '940.000', '', '0', '', '0', '150', '790.000', 9, 15, 1, 2);
...
(44, 13, 6, '1', '10.000', '10.000'),
(45, 13, 5, '4', '45.000', '180.000'),
(46, 13, 2, '10', '75.000', '750.000');
...
(2, '[\"2\"]', '[\"2\"]', 'Steak Ayam', '75.000', '<p>Ayam Kampung + Saus Tomat&nbsp; ++</p>', 'assets/images/product_image/5e4d3a411da64.jpg', 1),
(3, '[\"2\"]', '[\"2\"]', 'Steak Daging', '150.000', '<p>Daging Halal + Sapi Indonesia</p>', 'assets/images/product_image/5e4d3a911afc6.jpg', 1),
(4, '[\"2\"]', '[\"2\"]', 'Indomie Goreng', '25.000', '<p>Spesial Offer with Telur Dadar dan Sayuran</p>', 'assets/images/product_image/5e4d3b0c752bf.jpg', 1),
(5, '[\"3\"]', '[\"2\"]', 'Kopi Toraja', '45.000', '<p>Spesial Coffee with Robusta</p>', 'assets/images/product_image/5e4d3b7eee48e.jpg', 1),
(6, '[\"3\"]', '[\"2\"]', 'Air Mineral', '10.000', '<p>With Le Minerale Product</p>', 'assets/images/product_image/5e4d3c30c474c.jpg', 1);
...
(12, 'VVIP', '2', 1, 1, 2),
(13, 'Ruang Meeting', '20', 1, 1, 2),
(14, 'Tribun Utara', '10', 1, 1, 2),
(15, 'Tribun Testing', '10', 1, 1, 2);
...
(1, 'Manzola Caniago', '$2y$10$yfi5nUQGXUZtMdl27dWAyOd/jMOmATBpiUvJDmUu9hJ5Ro6BE5wsK', 'manzola@admin.com', 'Manzola', 'Caniago', '085865655044', 1, 0);
